...
<title>Liên Hệ | HANU-Homeware</title>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="contact-info">
						...
						<address>
							<p>HANU-HOMEWARE</p>
							<p>Km9 , Nguyễn Trãi, Thanh Xuân </p>
							<p>TP.Hà Nội, Việt Nam</p>
							<p>Mobile: +03 8968 0779</p>
							<p>Email: hieungo0499@gmail.com</p>
						</address>
						<div class="social-networks">
							<h2 class="title text-center">MẠNG XÃ HỘI</h2>
							<ul>
								<li><a target="_blank" href="https://www.facebook.com/minhhieu.ngo.731/"><i class="fa fa-facebook"></i></a></li>
