	...
	<section style="margin-top: 0" id="page-content">
        ...
        <div class="container">
            ...
            <div class="center-content">
                ...
                <p>Tất cả trung tâm bảo hành ủy quyền HANU-HOMEWARE trên toàn quốc đều được đào tạo và chỉ sử dụng linh kiện chính hãng HANU-HOMEWARE trong mọi hoạt động sửa chữa.</p>
                ...
                <a data-toggle="collapse" href="#demo" role="button" aria-expanded="false" aria-controls="collapseExample">
                        >>> Chính sách bảo hành của HANU-HOMEWARE
                </a>
            ...
            <div id="demo" class="bottom-content collapse">
                <h2>Chính sách bảo hành nhóm hàng gia dụng tại HANU-HOMEWARE</h2>
