...
<title>Home | HANU-Homeware</title>
<div id="fb-root"></div>
   ...
   <script>
	$(document).ready(function(){
		$("#btnSearch").click(function(){
			...
			$.ajax({
				type: "post",
				url: "/HANU_Homeware/searchServlet",
				data: {
					textSearch : textSearch
				},
				success : function(response){
					
						window.location.href="http://localhost:8080/HANU_Homeware/index10.jsp"
				...
				<div class="col-sm-6">
					<div class="contactinfo">
						<ul class="nav nav-pills">
							<li><a href="#"><i class="fa fa-phone"></i> +03 896 680 779</a></li>
							<li><a href="#"><i class="fa fa-envelope"></i>
									hieungo0499@gmail.com</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="social-icons pull-right">
						<ul class="nav navbar-nav">
							<li><a target="_blank" href="https://www.facebook.com/minhhieu.ngo.731/" title="Facebook"><i
					...
					<div class="shop-menu pull-right">
						<ul class="nav navbar-nav">
							...
							<li><a <%if(user!=null){%> style="display:block; " <%}
									...
									<li><a 
										href="/HANU_Homeware/profile.jsp">Thông tin tài khoản</a></li>
										<li><a 
										href="/HANU_Homeware/invoiceDetail.jsp">Xem chi tiết đơn hàng</a></li>
										<li><a 
										href="/HANU_Homeware/invoiceHistory.jsp">Xem lịch sử đơn hàng</a></li>
										<li>
		                            	<a href="/HANU_Homeware/CheckBH.jsp">Bảo hành sản phẩm</a> 
	                        		</li>
										<li><a 
