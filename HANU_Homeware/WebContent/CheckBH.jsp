...
<meta charset="UTF-8">
<title>HANU-HOMEWARE | Bảo Hành</title>
</head>
<body>
    <script>
	...
	<section style="margin-top: 0" id="page-content">
        ...
        <div class="container">
            ...
            <div class="center-content">
                <h3>TRUNG TÂM BẢO HÀNH HANU-HOMEWARE</h3>
                <p>Tất cả trung tâm bảo hành ủy quyền HANU-HOMEWARE trên toàn quốc đều được đào tạo và chỉ sử dụng linh kiện chính hãng TS-HOMEWARE trong mọi hoạt động sửa chữa.</p>
    ...
    <div class="modal-dialog">
		         ...
		         <!--      <span onclick="document.getElementById('id03').style.display='none'" class="close" title="Close Modal">&times;</span> -->
		            ...
		            <div id="poo1" class="container-12">
		            	...
		            	<p style="text-align:center">Cảm ơn quý khách đã sử dụng sản phẩm của <span style="color:red">HANU-HOMEWARE</span>.
