									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<tr class="odd gradeX">
												...
												<a href="/HANU_Homeware/InvoiceDetailServlet_Update_Del?action=Delete&ID_InvoiceDetail=<%=invoiceDetail.getID_InvoiceDetail() %>" onclick="return confirm('Bạn chắc chắn chứ ?')" class="btn btn-warning btn-xs">Hủy</a>
												</td>
											</tr>
										</tbody>
										<%
...
<head>
<meta charset="UTF-8">
<title>Xem chi tiết đơn hàng | HANU-Homeware</title>
<link href="css/bootstrap.min.css" rel="stylesheet">
<link href="css/font-awesome.min.css" rel="stylesheet">
<link href="css/prettyPhoto.css" rel="stylesheet">
<link href="css/price-range.css" rel="stylesheet">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										%>
											<tr class="odd gradeX">
												...
												<a href="/HANU_Homeware/InvoiceHistoryDetail?action=Cancel&ID_Invoice=<%=invoice.getID_Invoice() %>"  onclick="return confirm('Bạn có muốn hủy đơn hàng này không ?')"
													<% 
													if (invoice.getStatus_Order()==3) {											
												...
												<a href="/HANU_Homeware/InvoiceHistoryDetail?action=View&ID_Invoice=<%=invoice.getID_Invoice() %>"
